...
%>
<img src="http://signup.residentialwarrantyservices.com/images/renewals/v1<%=imagePrefix %>/PolicyExpiration2.jpg"/>
<div style="width: 560px; padding: 20px; font-family: sans-serif; margin-top: 20px">
	...
	<div style="width: 520px; padding: 20px; font-family: sans-serif; font-size: 14px; margin-top: 20px">
		Hello <%=name %>,<br/>
		<br/>
		Your <%=companyName %> home warranty has expired.<br/>
		<br/>
		Reduce the financial burden of a mechanical malfunction by extending your coverage. <b><a href="<%=renewalLink1%>">Visit the secure <%=companyAbbreviation %> Customer 
		Portal today</a></b> to update your information and submit your order.<br/>
		<br/>
		<b>FACT:</b> <i>Only <%=companyName %> covers underground Sewer and Water lines when you have our SIMPLE coverage plans.</i><br/>
		<br/>
		For a discounted monthly rate, you'll receive the same level of coverage.<br/>
		<br/>
...
<div style="width: 600px; text-align: center; margin-top: 20px">
	<a href="<%=renewalLink2%>">
		<img src="http://signup.residentialwarrantyservices.com/images/renewals/v1/renew-button-yellow.jpg"/>
	</a>
</div>
