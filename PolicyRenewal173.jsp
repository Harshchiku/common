...
%>
<img src="http://signup.residentialwarrantyservices.com/images/renewals/v1<%=imagePrefix %>/PolicyRenewal173.jpg"/>
<div style="width: 560px; padding: 20px; font-family: sans-serif; margin-top: 20px">
	<div style="width: 520px; padding: 20px; font-family: sans-serif; font-size: 14px; margin-top: 20px">
		Hello <%=name %>,<br/>
		<br/>
		There is still time to secure this amazing offer. Receive a structural warranty, a minimum of $350 annual value, at no charge through the remaining term of your 
		existing home warranty policy.<br/>
		<br/>
		A limited structural warranty includes guaranteed repairs and the ability to choose your own contractor. For exclusions and limitations, see full contract. 
		To receive the structural warranty, please go to the <a style="text-decoration: none; color: <%=linkColor %>" href="<%=renewalLink1%>"><%=companyAbbreviation %> 
		...
		<br/>
		Receive $10,000 worth of free coverage for structural issues just by putting your home warranty on automatic renewal...which comes with the added benefit of 
		ensuring there are never gaps in coverage.<br/>
		<br/>
		Don't wait. This offer expires on <%=renewBy %><br/>
		<br/>
		Questions? Call us today at <b>1-800-544-8156.</b>
	</div>
</div>
