...
%>
<img src="http://signup.residentialwarrantyservices.com/images/renewals/v1<%=imagePrefix %>/PolicyRenewal20.jpg"/>
<div style="width: 560px; padding: 20px; font-family: sans-serif; margin-top: 20px">
	...
	<div style="width: 520px; padding: 20px; font-family: sans-serif; font-size: 14px; margin-top: 20px">
		Hi <%=name %>,<br/>
		<br/>
		Don't let your home's protection lapse! Your current home warranty is expiring soon, but with RWS powered by Porch, you can continue enjoying comprehensive coverage.<br/>
		<br/>
		Upgrade Your Coverage Today:
		<ul>
		<li>Shield your home from unexpected breakdowns - essential systems and appliances included.</li>
		<li>Ensure your internal systems and appliances are fully safeguarded, with added handyman services and double appliance coverage.</li>
		...
		<br/>
		Extend your protection - renew now and secure your home's future!
		<br/><br/>
