...
%>
<img src="http://signup.residentialwarrantyservices.com/images/renewals/v1<%=imagePrefix %>/PolicyRenewal5.jpg"/>
<div style="width: 560px; padding: 20px; font-family: sans-serif; margin-top: 20px">
	<span style="font-weight: bold; font-size: 18px">
		Policy # <%=policyNumber %> at <%=address %> is expiring on <%=endDate %>.<br/><br/>
		Renew now with RWS powered by Porch and secure your home's future!
	</span>
	<div style="width: 520px; padding: 20px; font-family: sans-serif; font-size: 14px; margin-top: 20px">
		Hi <%=name %>,<br/>
		<br/>
		Your home warranty is set to expire in just 5 days on <%=endDate %>.<br/>

		Renew now to ensure your protection continues with RWS powered by Porch.<br/>
		<br/>
		Fact: A home warranty customer averages one claim per year.<br/>
		Extend your coverage to reduce the financial burden of mechanical malfunctions.<br/><br/>
		Renew Today and Stay Protected:<br/>
		<ul>
		...
		Renew now to secure your home's future - don't delay!<br/>
		<br/>
